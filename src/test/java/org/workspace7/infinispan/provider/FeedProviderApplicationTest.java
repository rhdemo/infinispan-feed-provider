...
import org.workspace7.infinispan.provider.config.InfinispanProviderConfiguration;
import org.workspace7.infinispan.provider.config.OpenWhiskProperties;

import static org.assertj.core.api.Assertions.assertThat;

@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE, classes = {InfinispanProviderConfiguration.class})
